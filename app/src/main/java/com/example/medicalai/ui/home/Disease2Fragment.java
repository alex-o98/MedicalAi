...
public class Disease2Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull final LayoutInflater inflater,
        ...
        root = inflater.inflate(R.layout.fragment_disease,null,false);
        result = inflater.inflate(R.layout.fragment_output,null,false);


        manual = inflater.inflate(R.layout.fragment_manual,container,false);
